...
int updateQuery=0;
        ...
        try {
              ...
              String s= "insert into intertrip_test_details(date,reason_of_testing_maintenance_tripping,trip_test_taken_through_protection_command,HV_CB_tripped,IV_CB_tripped,LV_CB_tripped,relay_indication,window_indication,remarks_and_name_of_engineer) values (?,?,?,?,?,?,?,?,?)";
                 ...
                 ps.setString(2,s2);
                   ps.setString(3,s3);
                     ps.setString(4,s4);
                       ...
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_INTERTRIP_TEST_DETAILS.jsp");
                       }                         

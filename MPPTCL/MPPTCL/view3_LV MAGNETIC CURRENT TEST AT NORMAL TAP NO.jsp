...
int updateQuery=0;
        ...
        try {
              ...
              String s= "update lv_magnetic_current_test_at_normal_tap_no set 3U_3V_3U_3V=?,3V_3W_3U_3V=?,3W_3U_3U_3V=?,3U_3V_3V_3W=?,3V_3W_3V_3W=?,3W_3U_3V_3W=?,3U_3V_3W_3U=?,3V_3W_3W_3U=?,3W_3U_3W_3U=?";
                 ...
                 ps.setString(2,s2);
                   ps.setString(3,s3);
                     ps.setString(4,s4);
                       ...
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_LV MAGNETIC CURRENT TEST AT NORMAL TAP NO.jsp");
                       }                         

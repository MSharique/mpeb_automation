...
String s="insert into `mpeb2`.`iv_magenetising_current_3phase_3wire_method`(TAP_NO_2U_2V, 2U_PHASE_2U_2V, 2V_PHASE_2U_2V, 2W_PHASE_2U_2V,TAP_NO_2V_2W, 2U_PHASE_2V_2W, 2V_PHASE_2V_2W, 2W_PHASE_2V_2W,TAP_NO_2W_2U, 2U_PHASE_2W_2U, 2V_PHASE_2W_2U, 2W_PHASE_2W_2U, voltage_1, voltage_2, voltage_3)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ps=con.prepareStatement(s);
			 ...
			 updateQuery=ps.executeUpdate();
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_pre_commisioning_test_result_3.jsp");
                       }                         

...
String s6 = request.getParameter("rad");
...
int updateQuery=0;
        ...
        try {
              ...
              String s= "update initial_mode_of_transportation_system set By_rail=?,By_road=?,With_Oil=?,Without_Oil=?,N2_Pressure_Checked_at_Site=?,N2_Cylinder_Returnable=?";
                 ...
                 ps.setString(2,s2);
                   ps.setString(3,s3);
                     ps.setString(4,s4);
                       ...
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_INITIAL_MODE_OF_TRANSPORTATION_SYSTEM.jsp");
                       }                         

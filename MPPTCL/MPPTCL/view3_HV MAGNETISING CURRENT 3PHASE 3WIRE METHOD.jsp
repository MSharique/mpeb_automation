...
int updateQuery=0;
        ...
        try {
              ...
              String s= "update hv_magenetising_current_3phase_3spare_method set TAP_NO_1U_1V=?,1U_PHASE_1U_1V=?,1V_PHASE_1U_1V=?,1W_PHASE_1U_1V=?,TAP_NO_1V_1W=?,1U_PHASE_1V_1W=?,1V_PHASE_1V_1W=?,1W_PHASE_1V_1W=?,TAP_NO_1W_1U=?,1U_PHASE_1W_1U=?,1V_PHASE_1W_1U=?,1W_PHASE_1W_1U=?";
                 ...
                 ps.setString(2,s2);
                   ps.setString(3,s3);
                     ps.setString(4,s4);
                       ...
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_HV MAGNETISING CURRENT 3PHASE 3WIRE METHOD.jsp");
                       }                         

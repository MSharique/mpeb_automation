...
String s="insert into `mpeb2`.`hv_magenetising_current_single_phase_method`(TAP_NO_1U_N, 1U_PHASE_1U_N, 1V_PHASE_1U_N, 1W_PHASE_1U_N,TAP_NO_1V_N, 1U_PHASE_1V_N, 1V_PHASE_1V_N, 1W_PHASE_1V_N,TAP_NO_1W_N, 1U_PHASE_1W_N, 1V_PHASE_1W_N, 1W_PHASE_1W_N,voltage_1, voltage_2, voltage_3) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ps=con.prepareStatement(s);
			 ...
			 updateQuery=ps.executeUpdate();
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_pre_commisioning_test_result_2.jsp");
                       }                         

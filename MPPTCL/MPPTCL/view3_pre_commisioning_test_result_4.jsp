...
String s="insert into `mpeb2`.`iv_magenetising_current_single_phase_method`(TAP_NO_2U_N, 2U_PHASE_2U_N, 2V_PHASE_2U_N, 2W_PHASE_2U_N, TAP_NO_2V_N, 2U_PHASE_2V_N, 2V_PHASE_2V_N, 2W_PHASE_2V_N, TAP_NO_2W_N, 2U_PHASE_2W_N, 2V_PHASE_2W_N, 2W_PHASE_2W_N, voltage_1, voltage_2, voltage_3) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ps=con.prepareStatement(s);
			 ...
			 updateQuery=ps.executeUpdate();
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_pre_commisioning_test_result_4.jsp");
                       }                         

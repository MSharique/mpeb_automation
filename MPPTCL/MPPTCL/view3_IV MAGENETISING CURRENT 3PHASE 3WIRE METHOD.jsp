...
int updateQuery=0;
        ...
        try {
              ...
              String s= "update iv_magenetising_current_3phase_3wire_method set TAP_NO_2U_2V=?,2U_PHASE_2U_2V=?,2V_PHASE_2U_2V=?,2W_PHASE_2U_2V=?,TAP_NO_2V_2W=?,2U_PHASE_2V_2W=?,2V_PHASE_2V_2W=?,2W_PHASE_2V_2W=?,TAP_NO_2W_2U=?,2U_PHASE_2W_2U=?,2V_PHASE_2W_2U=?,2W_PHASE_2W_2U=?";
                 ...
                 ps.setString(2,s2);
                   ps.setString(3,s3);
                     ps.setString(4,s4);
                       ...
                       if(updateQuery !=0)
                             {
                   response.sendRedirect("view_IV MAGENETISING CURRENT 3PHASE 3WIRE METHOD.jsp");
                       }                         

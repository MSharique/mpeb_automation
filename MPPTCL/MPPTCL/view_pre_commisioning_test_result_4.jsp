...
<form id="form1" name="form1" method="post" action="view2_pre_commisioning_test_result_4.jsp">
...
<% ResultSet rs = st.executeQuery("select * from iv_magenetising_current_single_phase_method");%>
<% int i=1;%>
...
<%rs.last();%>
<%  s1 = rs.getString("TAP_NO_2U_N");%>
<%  s2 = rs.getString("2U_PHASE_2U_N");%>
<%  s3 = rs.getString("2V_PHASE_2U_N");%>
<%  s4 = rs.getString("2W_PHASE_2U_N");%>
<%  s5 = rs.getString("TAP_NO_2V_N");%>
<%  s6 = rs.getString("2U_PHASE_2V_N");%>
<%  s7 = rs.getString("2V_PHASE_2V_N");%>
<%  s8 = rs.getString("2W_PHASE_2V_N");%>
<%  s9 = rs.getString("TAP_NO_2W_N");%>
<%  s10 = rs.getString("2U_PHASE_2W_N");%>
<%  s11 = rs.getString("2V_PHASE_2W_N");%>
<%  s12 = rs.getString("2W_PHASE_2W_N");%>
...
<p>
<h2 align="center">
IV MAGENETISING CURRENT SINGLE PHASE METHOD
</h2>
...
<tr> <td width="880" height="46" align="center"><p>
  <input type="submit" name="submit" value="update">
    ...
    <p><a href=" " onclick="window.print();return false;"><input style="" type="button" value="print" class="textboxclass">&nbsp; </p>
</td>
</tr>
</table>

...
<form id="form1" name="form1" method="post" action="view3_pre_commisioning_test_result_7.jsp">
<body>
...
<h4 align="center">RATIO TEST BY <input type="text" value="<%=st1%>" name="1"/>
 Make 
   <input type="text" value="<%=st2%>" name="2"/>
</h4>
<h4 align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Type <input type="text" value="<%=st3%>" name="3"/>


   Meter SI No. 
     <input type="text" value="<%=st4%>" name="4"/>
</h4> 
<table width="665" align="center" border="3">
  ...
  <% if(rs.next()){%>
    ...
    <tr>
      ...
      <th  colspan="2"><div align="center"><%=s1%>
      </div></th>
      <th  scope="col"><div align="center"><%=s2%>
      </div></th>
      <th scope="col"><div align="center"><%=s3%>
      </div></th>
      <th width="60" scope="col"><div align="center"><%=s4%>
      </div></th>
	...
	<tr>
        <th  scope="col"><div align="center"><%=i%></div></th>
      <th  colspan="2"><div align="center"><input type="text" value="" name="5"></div></th>
      <th  scope="col"><div align="center"><input type="text" value="" name="6"/>
      </div></th>
      <th scope="col"><div align="center"><input type="text" value="" name="7"/>
      </div></th>
      <th width="60" scope="col"><div align="center"><input type="text" value="" name="8"/>
      </div></th>
      </tr>
      </table>
      <% rs.close();%>

...
<form id="form1" name="form1" method="post" action="view3_mpeb5.jsp">
...
<td width="386" height="20"> <h3><strong> Boards -Order no. <br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-Date </strong></h2></td>
<td align="center"><input type="text" size="70" name="4" value="<%=s4%>"><br><input type="date"  name="5" size="70" value="<%=s5%>"></td></tr>

<tr bgcolor="#979797">
<td width="67" height="20"><h3><strong>(V)</strong></h3></td>
<td width="386" height="20"> <h3><strong> Sr. No. of Transformer </strong></h2></td>
<td width="420" align="center"><input type="text" name="6" size="70" value="<%=s6%>"></td></tr>
...
<td width="420" align="center"><input type="text" name="10" size="70" value="<%=s10%>"></td></tr>

<tr  bgcolor="#EEEEEE">
<td width="67" height="20"><h3><strong>(X)</strong></h3></td>
<td width="386" height="20"> <h3><strong> % Impedance at normal Tap </strong></h2></td>
<td width="420" align="center"><input type="text" name="11" size="70" value="<%=s11%>"></td></tr>
...
<tr> <td width="880" height="46" align="center">
